    ...
    if (isset($_SESSION['utente'])) { ?>
        <div class="container">
            <div class="intestazione intestazione2">
                <span class="titolo">Area geografica</span>
                <div class="btn btn-primary tooltip"><img src="https://img.icons8.com/ios/30/000000/help.png" />
                    <div class="right">
                        <p>In questa pagina puoi trovare un riepilogo delle visite in base al paese dei visitatori.</p>
                        <i></i>
                    </div>
                </div>
            </div>
            <div class="filter">
                <div class="form">
                    ...
                    <input type="submit" value="Filtra" onclick="reloadGraph('location')" class="filtra">
                </div>
            </div>
            <div class="XYchartLocation grafico">
            </div>
        </div>
    <?php
    } else {
